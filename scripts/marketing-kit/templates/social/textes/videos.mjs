...
export const STORIES = {
  ...
  S4: {
    ...
    etapes: [
      ...
      t(
        'Fais-toi un ami dans un pays que tu ne connais pas encore',
        'Make a friend in a country you’ve never been to',
        'Hazte amigo de alguien de un país que no conoces',
        'Finde Freunde in einem Land, das du noch nicht kennst',
        'Fatti un amico in un paese che non conosci ancora',
