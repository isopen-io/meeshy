...
final class ComposerDocumentSurfaceTests: XCTestCase {
    ...
    func test_leBrouillonDuDocument_porteSaListeNominative_quandLAudienceLExige() {
        let brouillon = ComposerDocumentDraft.document(
            format: .post, forcePlainPost: false, text: "bonjour", visibility: .only, visibilityUserIds: ["u1", "u2"], repostOfId: nil, localMedia: [], location: nil, discoverabilityPrecision: nil, originalLanguage: nil, mobileTranscription: nil, references: [], storyEffects: nil, mediaCaptions: [:]
        )
        XCTAssertEqual(
    ...
    func test_leBrouillonDuDocument_ecarteLaListe_quandLAudienceNeLExigePas() {
        let brouillon = ComposerDocumentDraft.document(
            format: .post, forcePlainPost: false, text: "bonjour", visibility: .public, visibilityUserIds: ["u1"], repostOfId: nil, localMedia: [], location: nil, discoverabilityPrecision: nil, originalLanguage: nil, mobileTranscription: nil, references: [], storyEffects: nil, mediaCaptions: [:]
        )
        XCTAssertNil(
    ...
    func test_leBrouillonDuDocument_porteSaSource_sansQuoiLAncragePerdSonOrigine() {
        let ancrage = ComposerDocumentDraft.document(
            format: .post, forcePlainPost: false, text: "je garde", visibility: .public, visibilityUserIds: [], repostOfId: "mood-source", localMedia: [], location: nil, discoverabilityPrecision: nil, originalLanguage: nil, mobileTranscription: nil, references: [], storyEffects: nil, mediaCaptions: [:]
        )
        XCTAssertEqual(
    ...
    func test_leBrouillonDuDocument_porteSonMediaSaPositionEtSaLangue() {
        ...
        let brouillon = ComposerDocumentDraft.document(
            ...
            localMedia: [media], location: lieu, discoverabilityPrecision: nil, originalLanguage: "es", mobileTranscription: nil, references: [], storyEffects: nil, mediaCaptions: [:]
        )
    ...
    func test_forcePlainPostArme_surUneVideoQualifiante_publieUnPOST() {
        ...
        let arme = ComposerDocumentDraft.document(
            ...
            visibilityUserIds: [], repostOfId: nil, localMedia: [video], location: nil, discoverabilityPrecision: nil, originalLanguage: nil, mobileTranscription: nil, references: [], storyEffects: nil, mediaCaptions: [:]
        )
        ...
        let intentArme = PublishIntent.document(
            ...
            mediaCaptions: arme.mediaCaptions
        )
        XCTAssertEqual(
        ...
        let intentNonArme = PublishIntent.document(
            ...
            mediaCaptions: nonArme.mediaCaptions
        )
        XCTAssertEqual(
    ...
    func test_lePlan_dUnPostAvecMedia_prendLaFileDurable_desDeuxCotesDuReseau() {
        ...
        let brouillon = ComposerDocumentDraft.document(
            format: .post, forcePlainPost: false, text: "bonjour", visibility: .public, visibilityUserIds: [], repostOfId: nil,
            localMedia: [media], location: nil, discoverabilityPrecision: nil, originalLanguage: nil, mobileTranscription: nil, references: [], storyEffects: nil, mediaCaptions: [:]
        )
    ...
    func test_lePlan_refuseUnBrouillonQuiNestPasUnPost() {
        for format in [ComposerFormat.status, .story, .reel] {
            let brouillon = ComposerDocumentDraft.document(
                format: format, forcePlainPost: false, text: "bonjour", visibility: .public, visibilityUserIds: [], repostOfId: nil, localMedia: [], location: nil, discoverabilityPrecision: nil, originalLanguage: nil, mobileTranscription: nil, references: [], storyEffects: nil, mediaCaptions: [:]
            )
            XCTAssertEqual(
                ComposerDocumentSendPlan.plan(for: brouillon, isOffline: false),
    ...
    func test_lePlan_refuseUnBrouillonSansMatiere() {
        for texte in ["", "   ", "\n"] {
            let brouillon = ComposerDocumentDraft.document(
                format: .post, forcePlainPost: false, text: texte, visibility: .public, visibilityUserIds: [], repostOfId: nil, localMedia: [], location: nil, discoverabilityPrecision: nil, originalLanguage: nil, mobileTranscription: nil, references: [], storyEffects: nil, mediaCaptions: [:]
            )
            XCTAssertEqual(
                ComposerDocumentSendPlan.plan(for: brouillon, isOffline: false),
                .refuse(.emptyDraft),
    ...
    func test_lePlan_refuseUneAudienceNominativeSansPersonne() {
        for nominative in PostVisibility.composerSelectableCases where nominative.requiresUserSelection {
            let brouillon = ComposerDocumentDraft.document(
                format: .post, forcePlainPost: false, text: "bonjour", visibility: nominative, visibilityUserIds: [], repostOfId: nil, localMedia: [], location: nil, discoverabilityPrecision: nil, originalLanguage: nil, mobileTranscription: nil, references: [], storyEffects: nil, mediaCaptions: [:]
            )
            XCTAssertEqual(
                ComposerDocumentSendPlan.plan(for: brouillon, isOffline: false),
            ...
            let complet = ComposerDocumentDraft.document(
                format: .post, forcePlainPost: false, text: "bonjour", visibility: nominative, visibilityUserIds: ["u1"], repostOfId: nil, localMedia: [], location: nil, discoverabilityPrecision: nil, originalLanguage: nil, mobileTranscription: nil, references: [], storyEffects: nil, mediaCaptions: [:]
            )
            XCTAssertEqual(
    ...
    func test_lePlan_dUnPostTexte_prendLeCheminDejaDurable_desDeuxCotesDuReseau() {
        let brouillon = ComposerDocumentDraft.document(
            format: .post, forcePlainPost: false, text: "bonjour", visibility: .public, visibilityUserIds: [], repostOfId: nil, localMedia: [], location: nil, discoverabilityPrecision: nil, originalLanguage: nil, mobileTranscription: nil, references: [], storyEffects: nil, mediaCaptions: [:]
        )
        for horsLigne in [true, false] {
            XCTAssertEqual(
                ComposerDocumentSendPlan.plan(for: brouillon, isOffline: horsLigne),
    ...
    func test_lePlan_refuseUneCitation_carSonCheminNestPasDurable() {
        let citation = ComposerDocumentDraft(
            ...
            audioUrl: nil, localMedia: [], location: nil, discoverabilityPrecision: nil, originalLanguage: nil, storyEffects: nil, mediaCaptions: [:],
