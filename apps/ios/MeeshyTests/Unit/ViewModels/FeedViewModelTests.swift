...
final class FeedViewModelTests: XCTestCase {
    ...
    func test_createOfflineMediaPost_enqueuesPostMediaAndInsertsOptimisticPost() async {
        ...
        await sut.createOfflineMediaPost(localMediaURLs: urls, content: "Photo post", originalLanguage: "en", mobileTranscription: nil, storyEffects: nil)
    ...
    func test_createOfflineMediaPost_enqueueRefused_rollsBackOptimisticPost() async {
        ...
        await sut.createOfflineMediaPost(localMediaURLs: [URL(fileURLWithPath: "/tmp/a.jpg")], content: "Doomed", mobileTranscription: nil, storyEffects: nil)
    ...
    func test_createOfflineMediaPost_emptyURLs_fallsBackToTextOnly() async {
        ...
        await sut.createOfflineMediaPost(localMediaURLs: [], content: "Just text", mobileTranscription: nil, storyEffects: nil)
