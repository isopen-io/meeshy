    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 0) {
            ...
            VStack(spacing: 8) {
                ...
                // **La ligne des pastilles de slides a été RETIRÉE**
                // (directive porteur 2026-09-06) : « l'indicateur de passage à
                // l'image suivante dans le plateau est inutile ! Donc la ligne
                // entière doit être enlevée ».
                //
                // Elle doublait la rangée de TUILES du header, qui dit déjà
                // combien de scènes la publication porte et laquelle on compose
                // — avec une vignette, une bordure et sa croix, là où les
                // pastilles ne donnaient qu'un rang. Le choix de DISPOSITION
                // qui l'accompagnait a rejoint l'éventail de format
                // (`ComposerFormatFan.dispositions`), avec la décision dont il
                // dépend.

                // **La bande contextuelle, entre la scène et la description**uelle, entre la scène et la description**
