    ...
    var body: some View {
        MeeshyComposerHost(
            ...
            onPublishDocument: { draft in
                ...
                //
                // Le publieur durable est celui qui ne demande pas de
                // `FeedViewModel` — cette porte n'en tient pas, comme celle du
                // tray. Il partage la règle d'envoi et la fabrique de charge
                // avec la porte du fil, et n'omet que l'insertion optimiste,
                // qu'aucun œil ne recevrait ici : le lecteur de stories n'est
                // pas le fil.
