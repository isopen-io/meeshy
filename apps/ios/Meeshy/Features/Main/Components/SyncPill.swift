...
struct SyncPill: View {
    ...
    private var pillContent: some View {
        ...
        .accessibilityHint(visibleEntry?.source != nil
            ? String(localized: "sync.a11y.tap_hint", defaultValue: "Touchez pour ouvrir l'emplacement de l'opération.", bundle: .main)
            : "")
    }
    ...
    private var accessibilityText: String {
        ...
        return String(
            format: String(localized: "sync.a11y.active_signal", defaultValue: "%1$d signaux. Actif : %2$@.", bundle: .main),
            entries.count,
            entry.label
        )
    }
