            ...
            RoundedRectangle(cornerRadius: 22)
                ...
                .overlay(
                    RoundedRectangle(cornerRadius: 22)
                        .stroke(
                            focusBounce ?
                            LinearGradient(colors: [MeeshyColors.brandPrimary.opacity(0.5), MeeshyColors.indigo600.opacity(0.5)], startPoint: .leading, endPoint: .trailing) :
                ...
                .shadow(color: focusBounce ? MeeshyColors.brandPrimary.opacity(0.2) : Color.clear, radius: 8, x: 0, y: 0)
        )
            ...
            Button {
                ...
                ZStack {
                    Circle()
                        .fill(
                            LinearGradient(
                                colors: [MeeshyColors.brandPrimary, MeeshyColors.indigo600],
                                startPoint: .topLeading,
                                endPoint: .bottomTrailing
                            )
                        )
                        .frame(width: 44, height: 44)
                        .shadow(color: MeeshyColors.brandPrimary.opacity(0.4), radius: sendBounce ? 12 : 8, x: 0, y: 4)
