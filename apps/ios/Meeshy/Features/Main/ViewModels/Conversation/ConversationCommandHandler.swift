...
final class ConversationCommandHandler {
    ...
    func deleteMessage(messageId: String, serverId: String, mode: ConversationViewModel.DeleteMode) async {
        switch mode {
        case .local:
    ...
    func editMessage(messageId: String, serverId: String, newContent: String) async {
    ...
    func togglePin(messageId: String, serverId: String, isPinned: Bool, currentUserId: String?) async {
        if isPinned {
    ...
    func reportMessage(messageId: String, serverId: String, reportType: String, reason: String?) async -> Bool {
        do {
    ...
    func deleteAttachment(messageId: String, attachmentId: String, originalAttachments: [MessageAttachment], serverId: String) async {
    ...
    func markAsRead(lastMessageId: String) {
    ...
    func toggleStar(message: Message, serverId: String, preview: String, conversationName: String?, conversationAccentColor: String?) -> Bool {
    ...
    func toggleReaction(messageId: String, serverId: String, emoji: String, participantId: String) {
