        ...
        VStack(alignment: .leading, spacing: 8) {
            HStack(spacing: 8) {
                ...
                VStack(alignment: .leading, spacing: 2) {
                    Text(parentMessage.senderName ?? String(localized: "thread.unknownSender", defaultValue: "Unknown", bundle: .main))
    ...
    private func replyRow(_ message: MeeshyMessage) -> some View {
        HStack(alignment: .top, spacing: 10) {
            ...
            VStack(alignment: .leading, spacing: 3) {
                HStack {
                    Text(message.senderName ?? String(localized: "thread.unknownSender", defaultValue: "Unknown", bundle: .main))
