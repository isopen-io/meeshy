    ...
    private var optionsSection: some View {
        VStack(alignment: .leading, spacing: 12) {
            ...
            VStack(spacing: 0) {
                ...
                toggleRow(title: String(localized: "settings.data.export.content.media", defaultValue: "Media", bundle: .main), icon: "photo.fill", color: MeeshyColors.trackingAccent, isOn: $includeMedia)
