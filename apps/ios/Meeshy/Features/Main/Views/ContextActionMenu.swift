...
extension ContextAction {
    ...
    /// from CLAUDE.md).
    static func reply(label: String = String(localized: "message.action.reply", defaultValue: "Reply", bundle: .main)) -> ContextAction {
        .init(kind: .reply, label: label, icon: "arrowshape.turn.up.left.fill", role: .standard)
    }
    static func forward(label: String = String(localized: "message.action.forward", defaultValue: "Forward", bundle: .main)) -> ContextAction {
        .init(kind: .forward, label: label, icon: "arrowshape.turn.up.right.fill", role: .standard)
    }
    static func react(label: String = String(localized: "message.action.react", defaultValue: "React", bundle: .main)) -> ContextAction {
        .init(kind: .react, label: label, icon: "face.smiling.fill", role: .primary)
    }
    static func translate(label: String = String(localized: "message.action.translate", defaultValue: "Translate", bundle: .main)) -> ContextAction {
        .init(kind: .translate, label: label, icon: "globe", role: .standard)
    }
    static func copy(label: String = String(localized: "message.action.copy", defaultValue: "Copy", bundle: .main)) -> ContextAction {
        .init(kind: .copy, label: label, icon: "doc.on.doc.fill", role: .standard)
    }
    static func delete(label: String = String(localized: "message.action.delete", defaultValue: "Delete", bundle: .main)) -> ContextAction {
        .init(kind: .delete, label: label, icon: "trash.fill", role: .destructive)
    }
    static func edit(label: String = String(localized: "message.action.edit", defaultValue: "Edit", bundle: .main)) -> ContextAction {
