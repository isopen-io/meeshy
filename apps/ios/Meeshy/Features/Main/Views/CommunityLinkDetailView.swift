    ...
    private var headerCard: some View {
        VStack(spacing: 10) {
            ZStack {
                ...
                // Glyphe héros dans un cercle de dimension fixe 60×60 : figé (déborderait s'il scalait) + masqué VoiceOver (doctrine 86i/91i)
        ...
        Button(action: action) {
            VStack(spacing: 6) {
                ZStack {
                    ...
                    // Glyphe dans un cadre de dimension fixe 52×52 : figé (déborderait s'il scalait) + masqué VoiceOver, le libellé porte le sens (doctrine 86i/91i)
