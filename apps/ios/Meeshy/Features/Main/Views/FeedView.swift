...
struct FeedView: View {
    ...
    private var composerPlaceholder: some View {
        ...
        .background(
            RoundedRectangle(cornerRadius: 20)
                .fill(theme.surfaceGradient(tint: MeeshyColors.indigo400Hex))
                .overlay(
                    RoundedRectangle(cornerRadius: 20)
                        .stroke(theme.border(tint: MeeshyColors.indigo400Hex, intensity: 0.25), lineWidth: 1)
                )
        )
        .padding(.horizontal, 16)
    }
        ...
        ZStack {
            ...
            .overlay(
                RoundedRectangle(cornerRadius: 24)
                    .stroke(theme.border(tint: MeeshyColors.indigo400Hex, intensity: 0.3), lineWidth: 1)
            )
            .padding(.horizontal, 16)
            .padding(.vertical, 80)
