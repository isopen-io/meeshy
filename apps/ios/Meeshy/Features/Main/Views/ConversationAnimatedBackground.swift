...
private struct ConvBgPulseRing: View {
    let index: Int
    let color: Color
...
private struct ConvBgFixedAvatar: View {
    let index: Int
    let totalCount: Int
    let color: Color
...
private struct ConvBgGlobePulseRing: View {
    let index: Int
    let color: Color
...
private struct ConvBgSatellite: View {
    let index: Int
    let color: Color
...
private struct ConvBgSignalWave: View {
    let waveIndex: Int
...
private struct ConvBgWaveShape: Shape {
    var phase: CGFloat
