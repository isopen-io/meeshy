    ...
    private var unreadCountCard: some View {
        ...
        .background(
            RoundedRectangle(cornerRadius: 20, style: .continuous)
                ...
                .shadow(
                    color: (totalUnread > 0 ? MeeshyColors.indigo500 : MeeshyColors.success).opacity(0.3),
                    radius: 16,
                    y: 8
                )
        )
        ...
        VStack(alignment: .leading, spacing: 12) {
            ...
            LazyVGrid(
                ...
                quickActionButton(
                    ...
                    gradient: [MeeshyColors.shareAccent, MeeshyColors.indigo600]
                ) {
                ...
                quickActionButton(
                    icon: "gearshape.fill",
                    label: String(localized: "widget.preview.action.settings", defaultValue: "R\u{00e9}glages", bundle: .main),
                    gradient: [MeeshyColors.neutral500, MeeshyColors.neutral600]
                ) {
                    dismiss()
                    DispatchQueue.main.asyncAfter(deadline: .now() + 0.3) {
