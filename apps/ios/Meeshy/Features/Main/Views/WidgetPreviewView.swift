    ...
    private var unreadCountCard: some View {
        ...
        .background(
            RoundedRectangle(cornerRadius: 20, style: .continuous)
                .fill(
                    LinearGradient(
                        colors: totalUnread > 0
                            ? [MeeshyColors.errorStrong, MeeshyColors.error]
                ...
                .shadow(
                    color: (totalUnread > 0 ? MeeshyColors.errorStrong : MeeshyColors.brandPrimary).opacity(0.3),
                    radius: 16,
                    y: 8
                )
        )
        ...
        VStack(alignment: .leading, spacing: 12) {
            ...
            LazyVGrid(
                ...
                quickActionButton(
                    ...
                    label: "Nouveau",
                    gradient: [MeeshyColors.indigo400, MeeshyColors.indigo500]
                ) {
                    dismiss()
                    DispatchQueue.main.asyncAfter(deadline: .now() + 0.3) {
                        onNewConversation?()
                ...
                quickActionButton(
                    ...
                    gradient: [MeeshyColors.errorSoft, MeeshyColors.errorStrong]
                ) {
                    dismiss()
                    DispatchQueue.main.asyncAfter(deadline: .now() + 0.3) {
