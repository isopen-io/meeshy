...
/** Garde de FORME pour `message:view-once-purged` (#7578) — fail-closed. */
...
/**
 * `applyMessageViewOncePurged` — LE CONTENU PART, LA BULLE RESTE (#7578,
 * #7580). Le serveur a purgé une vue unique (tous les destinataires l'ont
 * ouverte, ou son plafond de rétention est atteint) : la rangée passe
 * « déjà ouverte » et perd son contenu local. Ce n'est jamais un retrait.
 */
