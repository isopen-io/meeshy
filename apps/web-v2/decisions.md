...
## D-47 · La vérification d'e-mail et la réinitialisation du mot de passe voyagent en QUERY STRING ; le raccordement automatique depuis l'inscription reste hors tranche ; une route neuve grossit structurellement le socle — 2026-09-13 (#5672)
...
## D-48 · La grille de médias suit la géométrie iOS AU LITTÉRAL ; la visionneuse est un chunk à la demande dont la pellicule porte le MESSAGE ; un défaut de POSITION d'un témoin se corrige en CENTRANT, jamais en baissant un seuil — 2026-09-13 (#6169)
