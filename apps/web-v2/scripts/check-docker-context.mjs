...
const REQUIRED = [
  ...
  'apps/web-v2/nginx.conf',
  'apps/web-v2/public/sw-institutional.js',
  'apps/web-v2/public/sw-legacy-purge.js',
  'apps/web-v2/scripts/prerender-institutional.tsx',
  'apps/web-v2/scripts/check-nginx-public.sh',
  'apps/web-v2/scripts/lib/institutional-routes.mjs',
  'apps/web-v2/scripts/lib/institutional-routes.d.mts',
  'apps/web-v2/src/main.tsx',
  'apps/web-v2/src/styles/app.css',
  'apps/web-v2/src/styles/institutional.css',
  'apps/web-v2/src/styles/ios.css',
  'apps/web-v2/src/institutional/page.tsx',
  'apps/web-v2/src/lib/react-shim.js',
