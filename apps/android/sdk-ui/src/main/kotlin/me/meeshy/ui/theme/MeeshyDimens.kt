...
public object MeeshySpacing {
    ...
    public val scale: List<Dp> = listOf(none, xs, sm, md, lg, xl, xxl)
}

/** Corner-radius scale (charte graphique §13.6). */
public object MeeshyRadius {
    public val sm: Dp = 8.dp
    public val md: Dp = 12.dp
    public val lg: Dp = 14.dp
    public val xl: Dp = 20.dp

    /** Fully rounded — pills, circular containers. */
