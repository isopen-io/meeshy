...
//
//   node apps/web-old-version3/scripts/mesure-reseau.mjs http://127.0.0.1:3300/stories/abc [autre-url…]
//   node apps/web-old-version3/scripts/mesure-reseau.mjs --json --repetitions 5 http://127.0.0.1:3300/
//   node apps/web-old-version3/scripts/mesure-reseau.mjs --sans-emulation <url…>   # réseau local, non opposable
//
...
const main = async () => {
  ...
  if (urls.length === 0) {
    process.stderr.write(
      'usage : node apps/web-old-version3/scripts/mesure-reseau.mjs [--json] [--repetitions N] [--sans-emulation] <url…>\n',
    );
    return 1;
  }
  ...
  const commandePour = (url) =>
    `node apps/web-old-version3/scripts/mesure-reseau.mjs --repetitions ${repetitions} ${url}`;
