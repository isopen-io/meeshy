...
//
//   node apps/web-old-version3/scripts/baseline.mjs \
...
export const commandePour = (url) => `node apps/web-old-version3/scripts/baseline.mjs ${url}`;
...
export const POINT_OUVERT = {
  ...
  a_rejouer: 'node apps/web-old-version3/scripts/baseline.mjs <les 6 urls, avec de vrais identifiants publics>',
  prerequis: [
...
export const composeBaseline = ({ date, mesures, profil = null }) => {
  ...
  return {
    ...
    produit_par: 'node apps/web-old-version3/scripts/baseline.mjs <url…>',
    date,
    etablie,
    profil,
