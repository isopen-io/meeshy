...
// auto-signé et le pose dans `apps/web-old-version3/certificates/`. Mesuré sur celui que
// la première écriture du lot a produit :
//
//   openssl x509 -in apps/web-old-version3/certificates/localhost.pem -noout -text
