 ...
 * les fichiers compilés). Un `apps/web-old-version3/.env.local` — un fichier de
...
export const verifieQueLeBuildNAPasInlineUnePasserelleReelle = (racine: string = RACINE_V3): void => {
  ...
  throw new Error(
    `apps/web-old-version3/.env.local déclare NEXT_PUBLIC_API_URL=${valeur} — une origine RÉELLE, pas le bouchon. ` +
