...
import { soumetsLaFeuille } from '@/lib/realtime/feuille-de-lien';
...
const FIL: EtatDuFil['fil'] = { id: CLE, titre: TITRE, membres: 4, presence: { participants: [], presents: [] }, messages: [], plusAncien: null };
