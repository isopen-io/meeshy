...
const PARTICIPATION_DYNAMIQUE =
  "Les modules de participation (lib/realtime/participate.ts pour le fil, lib/realtime/liste.ts pour /chats, lib/realtime/feed.ts pour /feed, lib/realtime/notifs.ts pour /notifications, lib/realtime/contacts.ts pour /contacts, lib/realtime/recherche.ts pour /search) se chargent par `await import()` d'une adresse servie (`lib/actifs-rt.ts`), après le premier pixel — jamais par un import statique (§ 12.4).";
