          ...
          <>
            ...
            <div className="space-y-3 pt-2">
              ...
              >
                ...
                {t('register.wizard.phoneExistsModal.itsMyAccount', "It's my account - Sign in")}
              </Button>
              ...
              >
                ...
                {t('register.wizard.phoneExistsModal.notMyAccountContinue', 'Not my account - Continue without number')}
              </Button>
              ...
              <p className="text-xs text-center text-gray-500">
                {t('register.wizard.phoneExistsModal.smsWillBeSent', 'An SMS code will be sent to verify ownership of the number')}
              </p>
            </div>
          </>
        )}
          ...
          <>
            <DialogHeader>
              <DialogTitle className="flex items-center gap-2">
                ...
                {t('register.wizard.phoneExistsModal.smsVerification', 'SMS Verification')}
              </DialogTitle>
              <DialogDescription>
              ...
              <div className="text-center">
                {canResend ? (
                  ...
                  <p className="text-sm text-gray-500">
                    {t('register.wizard.phoneExistsModal.resendInSeconds', { seconds: resendCooldown })}
                  </p>
                )}
              </div>
          ...
          <>
            <DialogHeader>
              <DialogTitle className="flex items-center gap-2 text-green-600">
                ...
                {t('phoneReset.success', 'Verification successful!')}
              </DialogTitle>
              <DialogDescription>
