...
export function ReelPlayer({
  ...
  const reelBy = t('player.reelBy', { name });
  ...
  return (
    <section
      ...
      aria-label={t('player.position', { index: index + 1, total })}
      onWheel={onWheel}
    >
      <h1 className="sr-only">{reelBy}</h1>
