...
export function ReelPlayer({
  ...
  const mediaAlt = t('player.mediaAlt', { name });
  ...
  return (
    <section
      ...
      aria-label={t('player.counter', { current: index + 1, total })}
      onWheel={onWheel}
    >
      <h1 className="sr-only">{t('player.srHeading', { name })}</h1>
