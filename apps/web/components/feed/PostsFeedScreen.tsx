...
export function PostsFeedScreen() {
   ...
   *
   * REQUIS, jamais optionnel : c'est en le laissant absent de cet état que les
   * deux gestes ont émis `undefined`, et que le fil a fabriqué des POST à partir
   * de réels. Requis, la construction ne peut plus l'oublier — le compilateur
   * tient la loi à la place de la relecture.
   */
