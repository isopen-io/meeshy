...
export function ConversationList({
  ...
  // NOTE: Pas besoin de WebSocket ici car l'utilisateur est le seul à modifier SES préférences
  // Le state local est mis à jour directement lors des actions (pin, archive, etc.)
  useEffect(() => {
    ...
    // Pas de polling - les préférences sont mises à jour localement lors des actions utilisateur
