  ...
  return (
    <div className="grid gap-6">
      {pendingRequests.map((request) => {
        ...
        return (
          <Card key={request.id} className="relative border-2 hover:border-orange-500/50 hover:shadow-xl transition-[color,box-shadow] duration-200 overflow-hidden group bg-white dark:bg-gray-950">
                    ...
                    {isCurrentUserSender ? (
                      ...
                      <>
                        <Button
                          ...
                          className="flex-1 sm:flex-none items-center gap-2 h-9 sm:h-10 px-3 sm:px-4 bg-green-600 hover:bg-green-700 shadow-md hover:shadow-lg transition-[color,box-shadow]"
                        >
                        ...
                        <Button
                          ...
                          className="flex-1 sm:flex-none items-center gap-2 h-9 sm:h-10 px-3 sm:px-4 border-2 shadow-md hover:shadow-lg transition-[color,box-shadow]"
                        >
