    ...
    if (conversation.draft) {
      return (
        <span className="flex items-center gap-1">
          <span style={{ color: theme.colors.terracotta }}>✏️</span>
          <span className="truncate" style={{ color: theme.colors.terracotta }}>
            {conversation.draft}
          </span>
        </span>
      );
          ...
          <div className="flex items-center justify-between gap-2">
            <div className="flex items-center gap-1.5 min-w-0">
              ...
              {conversation.isPinned && (
                <span style={{ color: theme.colors.terracotta }}>📌</span>
              )}
              {conversation.isImportant && (
                <span style={{ color: theme.colors.goldAccent }}>⭐</span>
              )}
            </div>
            <span className="text-xs flex-shrink-0" style={{ color: theme.colors.textMuted }}>
