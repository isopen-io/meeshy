...
export function MediaImageCard({
  ...
  const renderSingleImage = () => (
    <button
      ...
      className="w-full overflow-hidden focus:outline-none focus:ring-2 focus:ring-offset-2 transition-transform duration-200 hover:scale-[1.01]"
      style={{
  ...
  const renderTwoImages = () => (
    <div
      ...
      style={{ borderRadius: theme.radii.lg, overflow: 'hidden' }}
    >
      {visibleImages.map((image, index) => (
        <button
          ...
          className="aspect-square overflow-hidden focus:outline-none focus:ring-2 focus:ring-inset transition-transform duration-200 hover:scale-[1.02]"
        >
          <img
            src={image.src}
  ...
  const renderThreeImages = () => (
    ...
    >
      <button
        type="button"
        onClick={() => handleImageClick(0)}
        className="row-span-2 overflow-hidden focus:outline-none focus:ring-2 focus:ring-inset transition-transform duration-200 hover:scale-[1.02]"
      >
        <img
      ...
      {visibleImages.map((image, index) => {
        ...
        return (
          <button
            ...
            type="button"
            onClick={() => handleImageClick(index)}
            className="aspect-square overflow-hidden relative focus:outline-none focus:ring-2 focus:ring-inset transition-transform duration-200 hover:scale-[1.02]"
          >
            <img
              src={image.src}
              alt={image.alt || `Image ${index + 1}`}
    ...
    <>
            ...
            {translations.length > 0 && (
              <div className="relative">
                ...
                >
                  ...
                  {selectedTranslation.isOriginal && (
                    <span
                      ...
                      style={{ backgroundColor: theme.colors.parchment, color: theme.colors.textMuted }}
                    >
                      Original
                    </span>
                  )}
                ...
                {showLanguageMenu && otherTranslations.length > 0 && (
                  <div
                    className="absolute top-full right-0 mt-2 z-30 rounded-lg shadow-lg overflow-hidden min-w-[200px] max-h-[200px] overflow-y-auto"
                    style={{
                      backgroundColor: 'white',
                  ...
                  >
                    ...
                    <div
                      ...
                      style={{
                        ...
                        backgroundColor: theme.colors.warmCanvas,
                      }}
                    >
      ...
      {isLightboxOpen && (
        ...
        >
          ...
          {selectedTranslation.caption && (
            <div
              className="absolute bottom-20 left-1/2 -translate-x-1/2 max-w-lg px-4 py-3 rounded-lg text-center"
