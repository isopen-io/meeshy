...
export const MessageComposer = forwardRef<MessageComposerRef, MessageComposerProps>(
  (props, ref) => {
    ...
    const textareaClassName = useMemo(() => {
      const baseClasses = 'expandable-textarea min-h-[60px] sm:min-h-[80px] max-h-40 resize-none pr-20 sm:pr-28 pb-12 pt-3 pl-3 border-2 border-blue-300/40 dark:border-blue-600/50 bg-gradient-to-br from-white/95 via-blue-50/80 to-white/95 dark:from-gray-800/95 dark:via-blue-950/80 dark:to-gray-800/95 backdrop-blur-md focus:border-blue-400/80 dark:focus:border-blue-500/80 focus:ring-4 focus:ring-blue-400/20 dark:focus:ring-blue-500/30 focus:bg-gradient-to-br focus:from-white focus:via-blue-50/60 focus:to-white dark:focus:from-gray-800 dark:focus:via-blue-950/60 dark:focus:to-gray-800 placeholder:text-gray-500 dark:placeholder:text-gray-400 text-gray-900 dark:text-gray-100 scroll-hidden transition-all duration-400';
    ...
    const textareaStyle = useMemo(() => ({
      ...
      boxShadow: isDarkMode
        ? '0 0 0 1px rgba(59, 130, 246, 0.25), 0 2px 12px rgba(59, 130, 246, 0.18), 0 8px 32px rgba(59, 130, 246, 0.12), inset 0 1px 0 rgba(59, 130, 246, 0.15)'
        : '0 0 0 1px rgba(59, 130, 246, 0.15), 0 2px 12px rgba(59, 130, 246, 0.12), 0 8px 32px rgba(59, 130, 246, 0.08), inset 0 1px 0 rgba(255, 255, 255, 0.6)',
