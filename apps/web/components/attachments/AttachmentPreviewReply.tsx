  ...
  return (
    <>
      <div
        ...
        role="list"
        aria-label={attachments.length > 1
          ? t('preview.attachmentCountPlural', { count: attachments.length })
          : t('preview.attachmentCount', { count: attachments.length })}
      >
        ...
        {images.map((attachment, index) => {
          ...
          return (
            ...
            >
              <NextImage
                src={safeFileUrl}
                alt={t('preview.imageAlt', { name: attachment.originalName || attachment.fileName })}
                fill
                sizes="60px"
        ...
        {videos.map((attachment, index) => (
          ...
          >
            ...
            <button
              ...
              aria-label={t('preview.openVideoFullscreen', { name: attachment.originalName || attachment.fileName })}
            >
        ...
        {pdfs.map(attachment => (
          <div
            ...
            role="button"
            tabIndex={0}
            aria-label={t('preview.openPdf', { name: attachment.fileName })}
          >
        ...
        {texts.map(attachment => (
          <div
            ...
            role="button"
            tabIndex={0}
            aria-label={t('preview.openTextFile', { name: attachment.fileName })}
          >
            <FileText className="h-5 w-5 flex-shrink-0" aria-hidden="true" />
            <span className="text-sm font-medium truncate max-w-[150px]">
              {attachment.originalName || attachment.fileName}
