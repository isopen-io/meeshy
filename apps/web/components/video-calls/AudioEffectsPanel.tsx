              ...
              <Popover>
                ...
                <PopoverContent className="w-64 bg-gray-800 border-gray-600 text-white text-xs p-2">
                  <div className="space-y-1">
                    <p className="font-semibold">{t('voiceCoder.title')}</p>
                    <p className="text-gray-300">{t('voiceCoder.description')}</p>
                    <div className="pt-1 space-y-0.5 text-[10px]">
                      <p><strong>{t('voiceCoder.retuneSpeed.label')}:</strong> {t('voiceCoder.retuneSpeed.shortDescription')}</p>
                      <p><strong>{t('voiceCoder.scale.label')}:</strong> {t('voiceCoder.scale.shortDescription')}</p>
                      <p><strong>{t('voiceCoder.strength.label')}:</strong> {t('voiceCoder.strength.shortDescription')}</p>
                      <p><strong>{t('voiceCoder.naturalVibrato.label')}:</strong> {t('voiceCoder.naturalVibrato.shortDescription')}</p>
                    </div>
                  </div>
                </PopoverContent>
              </Popover>
