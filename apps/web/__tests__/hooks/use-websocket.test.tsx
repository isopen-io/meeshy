...
jest.mock('@/services/websocket.service', () => ({
  webSocketService: {
    ...
    isConnected: (...args: any[]) => (mockIsConnected as any)(...args),
    getDiagnostics: (...args: any[]) => (mockGetDiagnostics as any)(...args),
    getConnectionStatus: (...args: any[]) => (mockGetConnectionStatus as any)(...args),
