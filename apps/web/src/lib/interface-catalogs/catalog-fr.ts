...
const fr = {
  ...
  /* LES MESSAGES FAVORIS (#7378, #7286) — l'étoile de « Plus… » dans le fil, l'écran `/me/starred-messages` et sa rangée de Réglages › Outils ; les clés et les valeurs d'iOS là où iOS en a (`action.star`, `starred.messages.*`, `settings.tools.starred`). */
  'action.star': 'Ajouter aux favoris',
  'action.unstar': 'Retirer des favoris',
  'announce.messageStarred': 'Ajouté aux favoris',
  'announce.messageUnstarred': 'Retiré des favoris',
  'starred.messages.pending': 'Favori non confirmé — hors ligne',
  'starred.messages.error': 'Impossible de modifier le favori',
  'starred.messages.notStarrable': 'Ce message ne peut pas être mis en favori',
  'settings.tools.starred': 'Messages favoris',
  'starred.messages.title': 'Messages favoris',
  'starred.messages.back': 'Retour aux réglages',
  'starred.messages.loading': 'Chargement des messages favoris',
  'starred.messages.empty.title': 'Aucun message favori',
  'starred.messages.empty.subtitle': 'Appuyez longuement sur un message et choisissez « Ajouter aux favoris » pour le retrouver ici.',
  'starred.messages.empty.cta': 'Ouvrir les conversations',
  'starred.messages.error.title': 'Impossible de charger vos messages favoris',
  'starred.messages.error.body': 'Réessayez dans un instant.',
  'starred.messages.offline.body': 'Vos messages favoris s’afficheront à la reconnexion.',
  'starred.messages.allLoaded': 'Tous vos messages favoris sont chargés',
  'starred.messages.row.hint': 'Ouvre la conversation',
  'starred.messages.remove.a11y': 'Retirer le message de {author} des favoris',
  'starred.messages.protected': 'Message protégé',
  'starred.messages.noText': 'Message sans texte',
  'starred.messages.media.image': 'Photo',
  'starred.messages.media.video': 'Vidéo',
  'starred.messages.media.audio': 'Audio',
  'starred.messages.media.file': 'Fichier',
  'common.unknown_user': 'Utilisateur',
  ...
  'story.studio.publishing.progress': 'Publication {done}/{total}…',
  'story.studio.outcome.partial': '{published} sur {total} publiées',
  ...
  /* PLUSIEURS PAGES (#7684) — le rail des scènes (rangée haute, `[+]` en
     tête du couloir droit) et le sous-menu de disposition (« Publier »
     déplié pour Post). */
  'story.studio.pages.label': 'Scènes de la publication',
  'story.studio.page.position': 'Scène {index} sur {count}',
  'story.studio.page.add': 'Créer une scène',
  'story.studio.page.remove': 'Supprimer la scène {index}',
  'story.studio.page.failed': 'un média n’a pas pu être envoyé',
  'story.studio.layout.title': 'Disposition des scènes',
  'story.studio.layout.carousel': 'Image par image',
  'story.studio.layout.reel': 'Défilement continu',
  'story.studio.layout.hero': 'Une grande, les autres à côté',
  'story.studio.layout.wave': 'En vague',
