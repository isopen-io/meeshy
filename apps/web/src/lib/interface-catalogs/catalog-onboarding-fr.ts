...
const fr = {
  ...
  'onboarding.email.title': 'Confirme ton adresse e-mail',
  'onboarding.email.body': 'Un lien t’attend dans ta boîte. Un clic, et tu pourras publier et inviter tes amis.',
  'onboarding.email.resend': 'Renvoyer le lien',
  'onboarding.email.sending': 'Envoi…',
  ...
  'onboarding.global.reward': '+{points} pts à l’envoi',
  ...
  'onboarding.story.reward': '+{points} pts à la publication',
  'onboarding.story.done': 'Story publiée !',
  'onboarding.story.verify': 'Pour publier ta story, confirme d’abord ton adresse e-mail.',

  'onboarding.friends.title': 'Trouve ta bande',
  'onboarding.friends.body': 'Ajoute 3 personnes qui te ressemblent. Quand elles acceptent, vous gagnez au moins\u00A0+{points} tous les deux.',
  ...
  'onboarding.friends.reward': 'Au moins\u00A0+{points} chacun quand elle accepte',
  ...
  'onboarding.recap.loading': 'Ta progression arrive…',
  ...
  'onboarding.recap.streak.one': 'Série : {days} jour',
  'onboarding.recap.streak.other': 'Série : {days} jours',
