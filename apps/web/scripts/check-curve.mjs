...
const DOWNSTREAM = `${ROOT}apps/web/src/lib/lens/law.ts`;
...
const DOWNSTREAM_FOCAL = `${ROOT}apps/web/src/lib/reading-mode/metrics.ts`;
 ...
 */
const DOWNSTREAM_THREAD = `${ROOT}apps/web/src/lib/reading-mode/perspective.ts`;
const DOWNSTREAM_ELECTION = `${ROOT}apps/web/src/lib/reading-mode/election.ts`;
...
const DOWNSTREAM_PROTECTION = `${ROOT}apps/web/src/lib/reading-mode/protection.ts`;
...
const THEME_CSS = `${ROOT}apps/web/src/styles/ios.css`;
const LENS_ROW = `${ROOT}apps/web/src/components/lens-row.tsx`;
const LENS_TIME = `${ROOT}apps/web/src/components/lens-time.tsx`;
...
const DOWNSTREAM_MENU_METRICS = `${ROOT}apps/web/src/lib/view/message-menu-metrics.ts`;
 ...
 */
{
  ...
  const metricsDerived = readFileSync(`${ROOT}apps/web/src/lib/reading-mode/metrics.ts`, 'utf8');
  const backdropDerived = readFileSync(`${ROOT}apps/web/src/lib/view/thread-backdrop.ts`, 'utf8');
 ...
 */
{
  ...
  const pullToRefreshDerived = readFileSync(`${ROOT}apps/web/src/lib/view/pull-to-refresh.ts`, 'utf8');
