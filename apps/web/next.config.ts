...
const nextConfig: NextConfig = {
  ...
  // Pretty share URLs — public-facing shapes claimed as Universal Links by
  // the iOS app (see apple-app-site-association). When users without the
  // app follow the link in a browser, Next.js internally serves the
  // existing page so the recipient still lands on the right surface.
  //
  ...
  // namespace (`Post` with `type: STORY`), so they reuse the post page.
  //
