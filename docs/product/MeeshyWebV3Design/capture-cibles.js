 ...
 * `apps/web-v3-old/scripts/lib/arguments-de-ligne.mjs`, avec ses temoins.
 *
 ...
 * apps/web-v3-old/scripts/lib/index-des-vues.mjs.
 *
...
(async () => {
  const { dossierDeSortie } = await import(
    pathToFileURL(path.join(ROOT, 'apps/web-v3-old/scripts/lib/arguments-de-ligne.mjs')).href);
