# Plan de correction — Itération 70w (Web)

> **Scope** : `apps/web` exclusivement. Référence d'analyse : `docs/analyses/uiux/2026-06-30-iteration-70w.md`.
...
1. **Résultats de recherche** (`invite-user-modal.tsx:212-239`)
   ...
   - Factoriser `userName` + `isSelected` dans le callback `map` (suppression de la triple répétition de l'expression de nom et du `selectedUsers.some(...)`).
