...
| Last merged PR | iter-54w (page story deep-link) #767 ✅ ; iter-55w (micro-surfaces FR : fallbacks Suspense + ReplyPreview) #769 ✅ ; iter-54wb (PostComposer/AudioPlayer) #768 ✅ ; iter-56w (dialogues AttachmentDelete + PhoneExists) `claude/practical-fermat-y3ci31-56w` ⏳ |
| Last Merged Base (commit) | `603ada4` (main HEAD post-#768) — base de l'iter-56w |
...
| 56w | claude/practical-fermat-y3ci31-56w (i18n dialogues AttachmentDelete + PhoneExists) | ⏳ | ⏳ |
