...
| Last merged PR | iter-51i (Liquid Glass context menu) #651 ✅ ; iter-52w (i18n ranking type labels) #765 ✅ ; iter-53w (i18n+a11y liste conv v2) `claude/practical-fermat-isk47b` ⏳ |
...
| 53w | claude/practical-fermat-isk47b (i18n+a11y liste conv v2) | ⏳ | ⏳ |
