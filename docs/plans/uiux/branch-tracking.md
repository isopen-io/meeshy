...
| Last merged PR | iter-49w (appel vidéo) mergée ; iter-49wb (ranking) #633 ✅ ; iter-49i #630 ✅ ; iter-50w (i18n/a11y audio/media/v2) `claude/focused-brown-u6wp8r` ⏳ |
| Last Merged Base (commit) | `97a1870c` (main HEAD post-merge iter-49i #630 + iter-49wb #633) — base de l'iter-50w |
| Next iteration | **51** — repartir de `main` HEAD post-merge iter-50w |
