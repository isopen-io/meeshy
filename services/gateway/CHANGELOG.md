...
- Changements automatiques détectés :
  ...
  - le refus d'appel gagne la parité ACK/retry/réconciliation de call:end (greffe PR #2807)
  ...
  - le chemin socket d'envoi porte le Prisme de la ligne de liste (greffe du delta PR #2806)
