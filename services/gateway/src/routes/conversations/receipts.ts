...
import {
  ...
  RECEIPTS_PEOPLE_DEFAULT_LIMIT,
  RECEIPTS_PEOPLE_MAX_LIMIT,
  RECEIPTS_RECENT_SCOPE_SIZE,
  createReceiptWriteRateLimitConfig,
  type ReceiptType,
  type ReceiptParams,
  type ReceiptAliasParams,
  type DeliveryReceiptAliasParams,
  type MessageReadStatusAliasParams,
  type ReadStatusesAliasQuery,
  type ReceiptsQuery,
  ReceiptWriteBodySchema,
  type ReceiptWriteBody,
  type ReceiptOutcome,
  type ReceiptFailure,
  type ReceiptReader,
  type ReceiptContext,
...
/**
 * Ré-export — tout symbole que ce fichier exportait avant la scission #4349 /
 * #4284 (directive 2026-08-28, budget de taille des fichiers de `routes/`)
 * reste importable d'ici, sans qu'aucun importeur n'ait à changer son chemin.
 * Définitions : `./receipts-contracts`.
 */
export {
  createReceiptWriteRateLimitConfig,
  RECEIPTS_MAX_WRITE_MESSAGE_IDS,
