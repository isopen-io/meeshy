  ...
  async saveVoiceProfile(
    ...
    return this.prisma.userVoiceModel.upsert({
      ...
      create: {
        ...
        embedding: profileData.embedding ? new Uint8Array(profileData.embedding) : undefined,
        ...
        chatterboxConditionals: profileData.chatterboxConditionals ? new Uint8Array(profileData.chatterboxConditionals) : null,
      ...
      update: {
        ...
        chatterboxConditionals: profileData.chatterboxConditionals ? new Uint8Array(profileData.chatterboxConditionals) : undefined,
