  ...
  async saveVoiceProfile(
    ...
    return this.prisma.userVoiceModel.upsert({
      ...
      create: {
        ...
        embedding: profileData.embedding ? Uint8Array.from(profileData.embedding) : undefined,
        ...
        chatterboxConditionals: profileData.chatterboxConditionals ? Uint8Array.from(profileData.chatterboxConditionals) : null,
      ...
      update: {
        ...
        chatterboxConditionals: profileData.chatterboxConditionals ? Uint8Array.from(profileData.chatterboxConditionals) : undefined,
