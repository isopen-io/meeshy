...
## Leçon 146 (2026-08-13) — `tasks/todo.md` est ÉPHÉMÈRE : vide en fin de session
...
## Leçon 207 — un tri-état résout une classe de problèmes, pas un champ : le voisin qu'on a laissé en `Optional` reste faux (2026-08-16, routine temps réel, cycle 49)
...
## Leçon 208 — une validation qui COMBLE ne peut pas servir à décider ce qui a été demandé (2026-08-16, routine temps réel, cycle 49)
