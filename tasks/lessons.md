...
## Leçon 214 — un champ nommé `participantId` peut désigner DEUX clés Prisma différentes selon l'événement qui le porte ; le nom seul ne prouve jamais l'espace d'identité (2026-08-17, routine calling, cycle 140)
