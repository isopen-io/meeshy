...
- Tests added: 193 new tests across 7 new test files
  ...
  - `__tests__/lib/voice-profile-utils.test.ts` (NEW, tests): IndexedDB helpers (getDB/openCursor/put/get/delete), base64ToBlob, VOICE_PROFILE_STORE/VOICE_RECORDINGS_STORE constants, error propagation
