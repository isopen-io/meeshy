...
| P1 | **Real-time** (Socket.IO presence, typing, reactions, delivery, reconnect) | ◐ sub: StatusHandler☑ ConversationHandler☑ AttachmentReactionHandler☑ LocationHandler☑ CallEventsHandler☑ MeeshySocketIOManager⚠deferred | ⊘ | ☐ | ☐ | ☐ | ☐ |
