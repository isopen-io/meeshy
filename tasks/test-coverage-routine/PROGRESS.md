...
| gateway | `pnpm --filter gateway test:coverage` | 67.53 (local) / 62.93 (CI Node 24) | 61.61 | 2026-06-22 (post P2 Admin & moderation × gateway sub-slice 4: agent-topics.ts 95%/93.47% + languages.ts 100%/96.15%; agent.ts 85%/71% partial; local stmts=67.29%/branches=61.61%/funcs=67.86%/lines=67.53%; CI (Node 24) stmts=62.87%/lines=62.93%; threshold floor ratcheted to CI-measured lines:63/branches:57/statements:63/functions:64; Node 22→24 gap = ~4-5pp) |
