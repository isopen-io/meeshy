...
| P1 | **ZMQ infra** (worker pool, connection mgr, multipart frames, dedup) | ◐ sub: ZmqMessageHandler.ts☑ ZmqRequestSender.ts☑ zmq-helpers.ts☑ ZmqTranslationClient.ts☑ ZmqConnectionManager.ts☐ | ☐ | ⊘ | ⊘ | ⊘ | ⊘ |
