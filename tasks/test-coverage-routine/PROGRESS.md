...
| P1 | **Conversations & membership** (create/join/leave/participants/settings) | ◐ sub: leave.ts☑ ban.ts☑ delete-for-me.ts☑ stats.ts☑ ConversationStatsService.ts☑ ConversationMessageStatsService.ts☑ conversation-id-cache.ts☑ identifier-generator.ts☑ access-control.ts☑ participants.ts☑ search.ts☑ threads.ts☑ index.ts☑ sharing.ts☑ (PR #702 merged); remaining: core.ts, messages-advanced.ts | ⊘ | ☐ | ☐ | ☐ | ☐ |
