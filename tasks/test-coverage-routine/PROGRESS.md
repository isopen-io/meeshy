...
| gateway | `pnpm --filter gateway test:coverage` | 72.62 (local) / ~68.1 (CI est.) | 68.31 (local) / ~63.8 (CI est.) | 2026-06-28 (post gateway-api-infra slice: errors/custom-errors.ts☑ utils/response.ts☑ utils/logger.ts☑ middleware/clientMutationId.ts☑ middleware/request-id.ts☑ middleware/validation.ts☑ validation/helpers.ts☑ config/user-preferences-defaults.ts☑ — 193 tests in slice; local stmts=72.49%/branches=68.31%/funcs=72.57%/lines=72.62%; threshold floor unchanged lines:67/branches:63/statements:67/functions:67 — CI-bun-calibrated gap ~4.5pp, floors are safe) |
