...
| gateway | `pnpm --filter gateway test:coverage` | ~78.59 (local) / ~74.0 (CI est.) | ~73.35 (local) / ~68.8 (CI est.) | 2026-06-29 (post gateway-manifest-gap8: routes/friends.ts 100%lines/97.5%branches; 342 suites / 10468 tests / 1 skipped; threshold floor unchanged lines:67/branches:63/statements:67/functions:67 — CI-bun-calibrated gap ~4.5pp, floors safe) |
