...
| translator | `.venv/bin/python -m pytest tests/ -m "not slow and not gpu and not e2e and not integration" --cov=src` | 54.77 | n/a | 2026-06-14 (Sprint 0.3 — import errors fixed; 1388 tests passing) |
