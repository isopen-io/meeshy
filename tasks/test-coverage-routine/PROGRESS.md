...
| P2 | **Calls** (WebRTC, call lifecycle, ICE restart) | ☑ sub: call-schemas.ts☑ CallService.ts☑ CallCleanupService.ts☑ routes/calls.ts☑ | ⊘ | ◐ sub: adaptive-degradation.ts☑(100%/96%) call-store.ts☑(100%/100%) use-call-quality.ts☑(100%/100%) use-video-call.ts☑(100%/97%) use-call-banner.ts☑(100%/100%) — webrtc-service.ts/video-calls components deferred | ☐ | ⊘ | ⊘ |
