...
| P1 | **Conversations & membership** (create/join/leave/participants/settings) | ◐ sub: leave.ts☑ ban.ts☑ delete-for-me.ts☑ stats.ts☑ ConversationStatsService.ts☑ ConversationMessageStatsService.ts☑; remaining: core.ts, messages-advanced.ts, sharing.ts, participants.ts, index.ts | ⊘ | ☐ | ☐ | ☐ | ☐ |
...
| gateway | `pnpm --filter gateway test:coverage` | 50.29 | 46.78 | 2026-06-17 (post P1 Conversations sub-split: leave☑ ban☑ delete-for-me☑ stats☑ ConversationStatsService☑ ConversationMessageStatsService☑; 164 new tests; threshold floor ratcheted to lines:50/branches:46/statements:50/functions:51) |
