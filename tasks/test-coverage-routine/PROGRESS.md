...
| shared | `pnpm --filter @meeshy/shared test:coverage` | 99.70 | 96.85 | 2026-06-23 (post P2 Notifications × shared; +91 tests, 917 total; 2 new files added to coverage: types/notification.ts☑(100%/100%) types/preferences/notification.ts☑(100%/100%); threshold floor unchanged lines:99/branches:96/functions:93/statements:99 — new measurements already above floor) |
