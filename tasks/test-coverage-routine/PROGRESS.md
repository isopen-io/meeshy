...
| gateway | `pnpm --filter gateway test:coverage` | ~75.2 (local) / ~70.5 (CI est.) | ~70.3 (local) / ~65.8 (CI est.) | 2026-06-29 (post gateway-manifest-gap6: validation schemas ×5 new test files + src/validation/**/*.ts added to collectCoverageFrom; 321 suites / 9702 tests / 1 skipped; threshold floor unchanged lines:67/branches:63/statements:67/functions:67 — CI-bun-calibrated gap ~4.5pp, floors safe) |
