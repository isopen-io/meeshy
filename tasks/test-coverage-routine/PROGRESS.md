...
| P2 | **Admin & moderation** | ◐ sub: services/admin/*☑ middleware/admin-user-auth☑ validation/admin-schemas☑ routes/admin/{analytics☑ anonymous-users☑ broadcasts☑ index☑ invitations☑ messages☑ posts☑} deferred:{agent content dashboard reports roles system-rankings users} | ⊘ | ☐ | ⊘ | ⊘ | ⊘ |
...
| gateway | `pnpm --filter gateway test:coverage` | 63.73 | 58.66 | 2026-06-21 (post P2 Admin & moderation × gateway sub-slice 2; stmts=63.37%/branches=58.66%/funcs=63.69%/lines=63.73%; threshold floor ratcheted lines:63/branches:58/statements:63/functions:63; 7 routes/admin/* files covered at ≥92% line+branch) |
