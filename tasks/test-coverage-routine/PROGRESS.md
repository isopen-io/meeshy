...
| gateway | `pnpm --filter gateway test:coverage` | 96.4 (local node) | 89.88 (local node) | 2026-06-30 (post gateway-routes-users: all 7 routes/users modules to ≥92% line+branch; 478 suites / 13268 tests / 1 skipped; threshold floor ratcheted lines:86→95/branches:79→88/statements:85→94/functions:82→92 — CI-bun-calibrated ~9pp gap) |
