...
| P0 | **Encryption & attachments** (E2EE, AES-GCM, encrypt-then-upload, audio attach) | ☑ | ⊘ | ☑ | ☐ | ☐ | ⚠ (encryption-service.ts 100%/94.28%; types/encryption.ts 100%; attachment-validators.ts 100%; types/attachment.ts 100%/100% — 10 functions + constants — PR #980 open, blocked by pre-existing gateway CI failures; reviewer PASS; merge-ready once gateway CI green) |
