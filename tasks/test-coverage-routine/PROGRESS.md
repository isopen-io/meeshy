...
| gateway | `pnpm --filter gateway test:coverage` | 95.44 (local node) | 88.85 (local node) | 2026-06-30 (post gateway-upload-coverage: upload.ts 56.7%→100% lines+branches; 458 suites / 12839 tests / 1 skipped; threshold floor unchanged lines:82/branches:75 — awaiting human merge of PR #1068 which contains a production bug fix before ratcheting) |
