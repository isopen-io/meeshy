...
| P1 | **Offline & sync** (outbox, failed-messages queue, reconnect flush) | ☑ sub: RedisDeliveryQueue.ts☑ delivery-queue-cleanup.ts☑ MessageReadStatusService.ts☑ MutationLogService.ts☑ withMutationLog.ts☑ | ⊘ | ☐ | ☐ | ☐ | ☐ |
