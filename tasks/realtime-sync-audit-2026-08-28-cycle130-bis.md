# Cycle 130 bis — la promesse détachée qui n'a d'autre écouteur que le process

> Le numéro porte un `bis` parce qu'un lot PARALLÈLE a pris `cycle130` pendant
> que celui-ci s'écrivait (`tasks/realtime-sync-audit-2026-08-28-cycle130.md`,
> Android et ses préférences, issue #4127). Les deux ne partagent aucun fichier
> de code — le leur est Kotlin, celui-ci est la passerelle — et la collision
> n'est que d'étiquette.
