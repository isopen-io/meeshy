# Audit synchro temps réel — cycle 40 (2026-08-15)

## Point de départ : la piste du cycle 38, et pourquoi elle n'est pas celle-ci

> **Numérotation.** Ce cycle a d'abord porté le numéro 39. Une autre session de
> la même routine instruisait au même moment la piste de contrat laissée par le
> cycle 38 (PR #3056, « l'acteur d'un read-status se reconnaît par
> `userId ?? participantId` »), et a livré son propre cycle 39 sur `main`. Les
> deux journaux sont conservés : le sien porte le 39, celui-ci le 40. Sa leçon
> 273 tire l'enseignement du doublon lui-même ; la leçon 274 est celle de ce
> cycle-ci.
