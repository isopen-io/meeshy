...
final class MockSocialSocket: SocialSocketProviding, @unchecked Sendable {
    ...
    let commentUnliked = PassthroughSubject<SocketCommentLikedData, Never>()
    ...
    let mediaCaptionTranslationUpdated = PassthroughSubject<SocketMediaCaptionTranslationUpdatedData, Never>()
