...
public struct SampleData {
    ...
    public static let conversations: [MeeshyConversation] = [
        MeeshyConversation(identifier: "marie_dupont", type: .direct, title: "Marie Dupont",
        ...
        MeeshyConversation(identifier: "dev_team", type: .group, title: "Equipe Dev",
        ...
        MeeshyConversation(identifier: "famille", type: .group, title: "Famille",
        ...
        MeeshyConversation(identifier: "global_chat", type: .public, title: "Global Chat",
        ...
        MeeshyConversation(identifier: "gaming_squad", type: .group, title: "Gaming Squad",
    ...
    public static let communities: [MeeshyCommunity] = [
        MeeshyCommunity(identifier: "meeshy_official", name: "Meeshy Officiel",
                  description: "La communaute officielle Meeshy", memberCount: 1500,
                  conversationCount: 12, emoji: "M", color: "4ECDC4"),
        MeeshyCommunity(identifier: "dev_hub", name: "Dev Hub",
                  description: "Pour les developpeurs", memberCount: 340,
                  conversationCount: 8, emoji: "D", color: "3498DB", theme: .tech),
        MeeshyCommunity(identifier: "music_lovers", name: "Music Lovers",
    ...
    public static func messages(conversationId: String = "sample") -> [MeeshyMessage] {
        [
            MeeshyMessage(conversationId: conversationId, senderId: "user1", content: "Salut ! Comment ca va ?",
                    createdAt: Date().addingTimeInterval(-3600), isMe: false),
            MeeshyMessage(conversationId: conversationId, senderId: "me", content: "Ca va bien merci, et toi ?",
                    createdAt: Date().addingTimeInterval(-3500), isMe: true),
            MeeshyMessage(conversationId: conversationId, senderId: "user1", content: "Super ! Tu as vu le nouveau design ?",
                    createdAt: Date().addingTimeInterval(-3400), isMe: false),
            MeeshyMessage(conversationId: conversationId, senderId: "me", content: "Oui c'est vraiment cool !",
                    createdAt: Date().addingTimeInterval(-3300), isMe: true),
            MeeshyMessage(conversationId: conversationId, senderId: "user1",
