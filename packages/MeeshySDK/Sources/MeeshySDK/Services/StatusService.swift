...
public protocol StatusServiceProviding: Sendable {
    ...
    func create(moodEmoji: String, content: String?, visibility: String, visibilityUserIds: [String]?, viaUsername: String?, audioUrl: String?, repostOfId: String?) async throws -> APIPost
...
public final class StatusService: StatusServiceProviding, @unchecked Sendable {
    ...
    public func create(moodEmoji: String, content: String?, visibility: String = "PUBLIC", visibilityUserIds: [String]? = nil, viaUsername: String? = nil, audioUrl: String? = nil, repostOfId: String? = nil) async throws -> APIPost {
        let body = CreatePostRequest(content: content ?? "", type: "STATUS", visibility: visibility, moodEmoji: moodEmoji, visibilityUserIds: visibilityUserIds, audioUrl: audioUrl, viaUsername: viaUsername, repostOfId: repostOfId)
