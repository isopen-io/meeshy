...
public enum ApiLegacySocketioEndpoint: MeeshyEndpoint, Sendable {
    case disconnectUser
    case stats

    public var path: String {
        switch self {
        case .disconnectUser: return "/api/socketio/disconnect-user"
        case .stats: return "/api/socketio/stats"
        }
    }
}
