...
public enum FriendRequestsEndpoint: MeeshyEndpoint, Sendable {
    case byId(id: String)
    case received
    case root
    case sent
    ...
    public var path: String {
        switch self {
        case .byId(let id): return "/api/v1/friend-requests/\(id)"
        case .received: return "/api/v1/friend-requests/received"
        case .root: return "/api/v1/friend-requests"
        case .sent: return "/api/v1/friend-requests/sent"
        }
    }
}
