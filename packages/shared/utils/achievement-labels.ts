...
export const ACHIEVEMENT_LABELS: Record<NotificationLanguage, FamilyLabels> = {
  fr: {
    ...
    'community.leave.count': '{n} communautés quittées',
  ...
  en: {
    ...
    'community.leave.count': '{n} communities left',
  ...
  es: {
    ...
    'community.leave.count': '{n} comunidades abandonadas',
  ...
  pt: {
    ...
    'community.leave.count': '{n} comunidades deixadas',
  ...
  de: {
    ...
    'community.leave.count': '{n} Communitys verlassen',
  ...
  it: {
    ...
    'community.leave.count': '{n} community lasciate',
  ...
  ar: {
    ...
    'community.leave.count': 'مغادرة {n} مجتمع',
  ...
  'zh-Hans': {
    ...
    'community.leave.count': '退出 {n} 个社区',
