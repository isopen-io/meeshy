...
export const SUPPORTED_LANGUAGES: readonly SupportedLanguageInfo[] = [
  ...
  // =========================================================================
  // ALIGNEMENT AVEC LA BASE DE TRADUCTION SDK (packages/MeeshySDK LanguageData)
  // Ces langues sont proposées par les pickers clients (onboarding iOS) : tout
  // code offert au choix de l'utilisateur DOIT être accepté par
  // AuthSchemas.register / UserSchemas.update (isSupportedLanguage), sinon
  // l'inscription échoue en « Données invalides ».
  // =========================================================================
  {
    code: 'sk',
    name: 'Slovak',
    ...
    flag: '🇸🇰',
    color: 'bg-blue-800',
    translateText: 'Preložiť túto správu do slovenčiny',
    supportsTTS: true,
    supportsSTT: true,
    supportsVoiceCloning: false,
    supportsTranslation: true,
  ...
  },
  {
    ...
    flag: '🇸🇮',
    color: 'bg-sky-700',
    translateText: 'Prevedi to sporočilo v slovenščino',
    supportsTTS: true,
    supportsSTT: true,
    supportsVoiceCloning: false,
    supportsTranslation: true,
  ...
  },
  {
    ...
    flag: '🇷🇸',
    color: 'bg-rose-800',
    translateText: 'Преведи ову поруку на српски',
    supportsTTS: false,
    supportsSTT: true,
    supportsVoiceCloning: false,
    supportsTranslation: true,
  ...
  },
  {
    ...
    flag: '🏴',
    color: 'bg-yellow-500',
    translateText: 'Tradueix aquest missatge al català',
    supportsTTS: false,
    supportsSTT: true,
    supportsVoiceCloning: false,
    supportsTranslation: true,
  ...
  },
  {
    ...
    flag: '🇪🇪',
    color: 'bg-sky-600',
    translateText: 'Tõlgi see sõnum eesti keelde',
    supportsTTS: false,
    supportsSTT: true,
    supportsVoiceCloning: false,
    supportsTranslation: true,
  ...
  },
  {
    ...
    flag: '🇱🇻',
    color: 'bg-red-800',
    translateText: 'Tulkot šo ziņojumu latviešu valodā',
    supportsTTS: false,
    supportsSTT: true,
    supportsVoiceCloning: false,
    supportsTranslation: true,
  ...
  },
  {
    ...
    flag: '🇦🇿',
    color: 'bg-cyan-600',
    translateText: 'Bu mesajı Azərbaycan dilinə tərcümə et',
    supportsTTS: false,
    supportsSTT: true,
    supportsVoiceCloning: false,
    supportsTranslation: true,
  ...
  },
  {
    ...
    flag: '🇰🇿',
    color: 'bg-sky-500',
    translateText: 'Бұл хабарламаны қазақ тіліне аудару',
    supportsTTS: false,
    supportsSTT: true,
    supportsVoiceCloning: false,
    supportsTranslation: true,
  ...
  },
  {
    ...
    flag: '🇺🇿',
    color: 'bg-teal-600',
    translateText: "Ushbu xabarni o'zbek tiliga tarjima qilish",
    supportsTTS: false,
    supportsSTT: true,
    supportsVoiceCloning: false,
    supportsTranslation: true,
  ...
  },
  {
    ...
    flag: '🇬🇪',
    color: 'bg-red-700',
    translateText: 'თარგმნე ეს შეტყობინება ქართულად',
    supportsTTS: false,
    supportsSTT: true,
    supportsVoiceCloning: false,
    supportsTranslation: true,
  ...
  },
  {
    ...
    flag: '🇮🇳',
    color: 'bg-amber-600',
    translateText: 'இந்த செய்தியை தமிழில் மொழிபெயர்க்கவும்',
    supportsTTS: true,
    supportsSTT: true,
    supportsVoiceCloning: false,
    supportsTranslation: true,
  ...
  },
  {
    ...
    flag: '🇳🇵',
    color: 'bg-red-600',
    translateText: 'यो सन्देश नेपालीमा अनुवाद गर्नुहोस्',
    supportsTTS: false,
    supportsSTT: true,
    supportsVoiceCloning: false,
    supportsTranslation: true,
  ...
  },
  {
    ...
    flag: '🇲🇲',
    color: 'bg-yellow-600',
    translateText: 'ဤစာကို မြန်မာဘာသာသို့ ဘာသာပြန်ပါ',
    supportsTTS: false,
    supportsSTT: true,
    supportsVoiceCloning: false,
    supportsTranslation: true,
  ...
  },
  {
    ...
    flag: '🇰🇭',
    color: 'bg-blue-900',
    translateText: 'បកប្រែសាររបស់នេះជាភាសាខ្មែរ',
    supportsTTS: false,
    supportsSTT: true,
    supportsVoiceCloning: false,
    supportsTranslation: true,
  ...
  },
  {
    ...
    flag: '🇱🇦',
    color: 'bg-red-700',
    translateText: 'ແປຂໍ້ຄວາມນີ້ເປັນພາສາລາວ',
    supportsTTS: false,
    supportsSTT: true,
    supportsVoiceCloning: false,
    supportsTranslation: true,
  ...
  },
  {
    ...
    flag: '🇵🇭',
    color: 'bg-blue-600',
    translateText: 'Isalin ang mensaheng ito sa Filipino',
    supportsTTS: false,
    supportsSTT: true,
    supportsVoiceCloning: false,
    supportsTranslation: true,
  ...
  },
  {
    ...
    flag: '🇸🇳',
    color: 'bg-cyan-600',
    translateText: 'Traduire ce message en Fulfulde',
    supportsTTS: true,
    supportsSTT: true,
    supportsVoiceCloning: false,
    supportsTranslation: true,
  ...
  },
  {
    ...
    flag: '🇬🇭',
    color: 'bg-amber-600',
    translateText: 'Traduire ce message en Twi',
    supportsTTS: false,
    supportsSTT: true,
    supportsVoiceCloning: false,
    supportsTranslation: true,
  ...
  },
  {
    ...
    flag: '🇬🇭',
    color: 'bg-orange-600',
    translateText: 'Traduire ce message en Akan',
    supportsTTS: false,
    supportsSTT: false,
    supportsVoiceCloning: false,
    supportsTranslation: true,
  ...
  },
  {
    ...
    flag: '🇲🇱',
    color: 'bg-yellow-600',
    translateText: 'Traduire ce message en Bambara',
    supportsTTS: false,
    supportsSTT: false,
    supportsVoiceCloning: false,
    supportsTranslation: true,
  ...
  },
  {
    ...
    flag: '🇨🇲',
    color: 'bg-green-600',
    translateText: 'Traduire ce message en Medumba',
    supportsTTS: false,
    supportsSTT: false,
    supportsVoiceCloning: false,
    supportsTranslation: true,
  ...
  },
  {
    ...
    flag: '🇨🇲',
    color: 'bg-sky-600',
    translateText: 'Traduire ce message en Fang',
    supportsTTS: false,
    supportsSTT: false,
    supportsVoiceCloning: false,
    supportsTranslation: true,
