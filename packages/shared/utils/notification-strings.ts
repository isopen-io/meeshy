...
export const NOTIFICATION_STRING_KEYS = [
  ...
  'call.action.answer', 'call.action.decline',
...
const TEMPLATES: Record<NotificationLanguage, Templates> = {
  ...
  de: {
    ...
    'call.incoming.body': '{callBody}',
    'call.action.answer': 'Annehmen',
    'call.action.decline': 'Ablehnen',
  ...
  it: {
    ...
    'call.incoming.body': '{callBody}',
    'call.action.answer': 'Rispondi',
    'call.action.decline': 'Rifiuta',
  ...
  ar: {
    ...
    'call.incoming.body': '{callBody}',
    'call.action.answer': 'رد',
    'call.action.decline': 'رفض',
  ...
  'zh-Hans': {
    ...
    'call.incoming.body': '{callBody}',
    'call.action.answer': '接听',
    'call.action.decline': '拒绝',
